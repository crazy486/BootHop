...
pub use firmware::{
    BOOT_ATTRIBUTES, BOOT_CURRENT_ATTRIBUTES, CallError, FirmwareType, INITIAL_BUFFER_BYTES,
    MAX_ENUMERATION_BYTES, MAX_PAYLOAD_BYTES, ReadOutcome, ReadStatus, VariableName, WindowsCalls,
    check_environment, read_next, read_options,
};
